...
public class Dialogue
{
        ...
        if (this.curentRoom.getDescription().equals(
            ...
            if (str.equals("yes")) {
                ...
                if (str1.equals(content[3])) {
                    System.out.println("Bien jouer ! le catcheur mafieux SATAN"
                    ...
                    System.out.println("Mauvaise réponse !" + 
                        " je ne peux rien te dire sur SATAN ! \n" + 
                        "à la prochaine fois...");
                ...
                System.out.println("ahaha je comprends que t'as peur mon petit "
                    + this.hero.getNom() + "\n" +
                    "à la prochaine fois...") ;  
            }           
            System.out.println();   
    ...
    {
        String [] str = {"dans le bar où tous " +
                "les boissons sont super alcoolisées !", 
    ...
    {
        String [] str = {"dans le Forêt sauvage, " +
                "où seuls les braves ont leur place !", 
    ...
    public String [] circusTalk () 
    {
        String [] str = {"dans le cirque des acrobaties dangeureuse !",
            " Pendant combien de jours un être humain " +
                "peut vivre sans manger ? : ",
            " 1- 5 jours \n 2- 9 jours  \n 3- 7 jours  \n 4- 30 jours",
            "4"};
        return str; 
    }
    ...
    public String [] bikeTalk () 
    {
        String [] str = {"dans le club des motards fous !",
            "quel est le constructeur de moto le plus connu au monde " +
                "pour ses grosses cylindrées ? : ", 
            " 1-Suzuki \n 2-Renault  \n 3- Ferrari \n 4- Harley davidson",
            "4"};
        return str; 
    }
    ...
    {
        String [] str = {"au bord de l'avion qui vole " +
                "vers toutes les destinations !",
            "quelle est l'altitude minimal en KM  à partir " +
                "de la quelle l'avion peut voler ? : ",
            " 1- 1000 km \n 2- 8000 km  \n 3- 50 km \n 4- 600 km ",
            "2"};
        return str;        
    }
        ...
        if (str.equals("yes")) {
            ...
            if (str2.contains("kamikaze")) {
                ...
                System.out.println("Non, ce n'est pas ça ! " + 
                    "il va falloir m'affronter " + 
                    "dans une version plus améliorée de ce jeu !");
            }
        } 
        System.out.println("*************************************************");
